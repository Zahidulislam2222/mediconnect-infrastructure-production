...
| Security CI history gate: the full-history secret scan fails on repositories whose old commits still hold the findings above | Open until each finding is revoked and triaged |
